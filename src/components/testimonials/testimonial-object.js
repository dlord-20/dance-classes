...
class TestimonialsObject {
  ...
  const student2 = new TestimonialsObject('Bodi', 'K1', 'Dance is the best. Miss Nicole is my favorit.', '22/01/21', 5, true);
  ...
  export const danceClasses = [student1, student2, parent1, parent2];